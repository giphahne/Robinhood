...
class Robinhood:
    ...
    endpoints = {
        ...
        "ach_iav_auth":
        "https://api.robinhood.com/ach/iav/auth/",
        "ach_relationships":
        ...
        "notifications":
        "https://api.robinhood.com/notifications/",
        "orders":
        ...
        "tags":
        "https://api.robinhood.com/midlands/tags/tag/",
        "oath2":
        "https://api.robinhood.com/oauth2/migrate_token/",
        "options":
    ...
    def get_historical_quotes(self,
        ...
        res = self.session.get(
            endpoints.historicals(), params=params, timeout=15)
        return res.json()
    ...
    def get_news(self, stock):
        ...
        return self.session.get(
            endpoints.news(stock.upper()), timeout=15).json()
    ...
    def securities_owned(self):
        ...
        return self.session.get(
            endpoints.positions() + '?nonzero=true', timeout=15).json()
    ...
    def place_order(self,
        ...
        Place an order with Robinhood
            ...
            Notes:
                ...
                Just realized this won't work since if type 
                is LIMIT you need to use "price" and if
    ...
    def submit_order(self,
        ...
        if (symbol is None):
            symbol = self.session.get(
                instrument_URL, timeout=15).json()['symbol']
        ...
        for field, value in [('account', self.get_account()['url']),
                             ('instrument',
                              instrument_URL), ('symbol',
                                                symbol), ('type', order_type),
                             ('time_in_force',
                              time_in_force), ('trigger', trigger), ('price',
                                                                     price),
                             ('stop_price', stop_price), ('quantity',
                                                          quantity), ('side',
                                                                      side)]:
